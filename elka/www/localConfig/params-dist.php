...
return array(
    ...
    // тексты на странице
    'announceText' => '<p>Вы можете стать участником нашей акции и подарить детям-сиротам желанный новогодний подарок.</p><p class="red">Нажмите кнопку и следуйте инструкцям.</p>',
    'socialButtonsText' => '
    ...
    'partnersText' => '
											...
											',
    'footerText' => 'Проект портала <a href="">66.ru</a>',
    'underNewsText' => '',
